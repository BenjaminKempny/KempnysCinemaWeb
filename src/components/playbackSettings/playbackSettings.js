...
function loadForm(context, user, userSettings, systemInfo, apiClient) {
    ...
    context.querySelector('.chkEnableSimplePlayer').checked = userSettings.enableSimplePlayer();
...
function saveUser(context, user, userSettingsInstance, apiClient) {
    ...
    userSettingsInstance.enableSimplePlayer(context.querySelector('.chkEnableSimplePlayer').checked);
